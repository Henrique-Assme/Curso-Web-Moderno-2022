...
export default {
    ...
    methods: {
        loadArticles() {
            axios(`${baseApiUrl}/articles?page=${this.page}`).then(res => {
        ...
        loadCategories() {
            axios(`${baseApiUrl}/categories`).then(res => {
            ...
            axios[method](`${baseApiUrl}/articles${id}`, this.article)
                .then(() => {
                    this.$toasted.global.defaultSuccess({ 
                        msg: this.article.id ? 
                        'Categoria alterado com sucesso!' :
        ...
        remove() {
            ...
            axios.delete(`${baseApiUrl}/articles/${id}`)
                .then(() => {
                    this.$toasted.global.defaultSuccess({ msg: 'Categoria excluido com sucesso!' })
                    this.reset()
                })
                .catch(showError)
        },
